...
model = pickle.load(open('D:\python\Project\Placement\op.pkl', 'rb'))
salary = pickle.load(open('D:\python\Project\Placement\salary.pkl','rb'))
...
def predict():
    ...
    if predictions == [1]:
        ...
        return render_template(
            'home.html',
            prediction_text=
            '''With this track record YOU WILL BE PLACED!
        ...
        return render_template(
            'home.html',
            prediction_text=
            '''With this track record you will NOT be PLACED!
